...
def callback_Init(data):
  ...
  #xcordinit = round(data.pose.pose.position.x, 4)		#Round the value of x to 4 decimal places
  #ycordinit = round(data.pose.pose.position.y, 4)		#Round the value of y to 4 decimal places
...
sub1 = rospy.Subscriber("/odom", Odometry, callback_Init) #Identify the subscriber "sub1" to subscribe topic "/turtle1/pose" of type "Pose"
#######################################################################
#######################################################################
...
sub2 = rospy.Subscriber("/odom", Odometry, callback) #Identify the subscriber "sub2" to subscribe topic "/turtle1/pose" of type "Pose"
#######################################################################
#######################################################################
